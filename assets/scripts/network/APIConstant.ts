export default class APIConstant {
    ...
    static ITEMS_FOR_PLANTING = "items-for-planting";
}
...
export class EVENT_NAME {
    ...
    static ON_CLICK_BUTTON_A_MOBILE = "ON_CLICK_BUTTON_A_MOBILE";
    static ON_CLICK_BUTTON_B_MOBILE = "ON_CLICK_BUTTON_B_MOBILE";
    static ON_CLICK_BUTTON_CHAT_MOBILE = "ON_CLICK_BUTTON_CHAT_MOBILE";
