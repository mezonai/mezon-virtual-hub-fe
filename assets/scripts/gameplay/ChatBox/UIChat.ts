import { _decorator, Button, Component, EditBox, game, instantiate, Layout, Prefab, ScrollView, Node, SystemEvent,systemEvent, KeyCode, Color, RichText, UITransform, input, Input } from 'cc';
